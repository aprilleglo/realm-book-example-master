...
public class BooksAdapter extends RealmRecyclerViewAdapter<Book, BooksAdapter.BookViewHolder> {
    ...
    public static class BookViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Book book) {
            ...
            File BloisUserDir;
            File BloisUserTempFile;
            String fileFrombookUrl;
            ...
            if (book.getImageUrl() != null) {
                fileFrombookUrl = book.getImageUrl();
                Log.e("TravellerLog :: ", "fileFrombookUrl " + fileFrombookUrl);
            } else {
                fileFrombookUrl = "myimage.png";
                Log.e("TravellerLog :: ", "fileFrombookUrl else " + fileFrombookUrl);
            }

            BloisUserTempFile = new File(BloisUserDir, fileFrombookUrl);
            if (BloisUserTempFile.exists() ){
                Log.e("TravellerLog :: ", "tempfile exists" + BloisUserTempFile.toString() );
            } else {
            ...
            if(BloisUserTempFile.exists()){
                ...
                Bitmap myBitmap = BitmapFactory.decodeFile(BloisUserTempFile.getAbsolutePath());
